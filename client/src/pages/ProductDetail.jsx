          ...
          <div className="px-1.5">
            <div className="flex flex-wrap mx-[-12px] ">
              ...
              <div className="h-[510px] w-[160px] max-h-[650px] px-[12px]  cursor-pointer flex flex-col items-center">
                <img
                  className="my-2 h-[115px] w-[84px]"
                  src={pro.image ? pro.image : ""}
                  alt=""
                  onClick={(e) => handleImgChange(pro.image)}
                />
                <img
                  className="my-2 h-[115px] w-[84px]"
                  src={fix1}
                  alt=""
                  onClick={(e) => handleImgChange(fix1)}
                />
                <img
                  className="my-2 h-[115px] w-[84px]"
                  src={fix2}
                  alt=""
                  onClick={(e) => handleImgChange(fix2)}
                />
              </div>
              <div className="w-2/5 flex flex-col max-w-full px-[12px] ">
                ...
                <div className="flex items-center mb-2">
                  <div className="mr-[20px] text-yellow-300 text-2xl">
                    ★★★★★
                  </div>
                ...
                <div className="mb-3 mt-1 p-[4px] bg-[#1E2125] rounded-[4px] w-[245px]">
                  {!addedcart ? (
                    <button
                      className=" cursor-pointer h-[24px] w-[245px] text-white flex justify-center items-center"
                ...
                <div className="mb-3 mt-1 cursor-pointer flex items-center">
                  ...
                  <a
                    className="mx-[4px]"
                    href="https://api.whatsapp.com/send/?text=SUGAR+Cosmetics+-+Check+this+out%3B+you%27ll+love+it%21+https%3A%2F%2Fin.sugarcosmetics.com%2Fproducts%2Fpowder-play-banana-compact&type=custom_url&app_absent=0"
                    target="_blank"
                  >
                    <img
                  ...
                  <a
                    className="mx-[4px]"
                    href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fin.sugarcosmetics.com%2Fproducts%2Fpowder-play-banana-compact&text=SUGAR%20Cosmetics%20-%20Check%20this%20out%3B%20you%27ll%20love%20it!"
                  >
                    <img
                      className="h-[22px] w-[22px]"
